...
AMyFirstPersonPawn::AMyFirstPersonPawn()
{
	...
	PawnAttributeAsset = LoadObject<UMyPawnAttributesDataAsset>(nullptr, TEXT("/Script/Assignment2.MyPawnAttributesDataAsset'/Game/Blueprint/FPP_DataAsset.FPP_DataAsset'"));
}
