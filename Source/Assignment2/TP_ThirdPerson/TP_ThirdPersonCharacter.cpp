...
ATP_ThirdPersonCharacter::ATP_ThirdPersonCharacter()
{
	...
	PawnAttributeAsset = LoadObject<UMyPawnAttributesDataAsset>(nullptr, TEXT("/Script/Assignment2.MyPawnAttributesDataAsset'/Game/Blueprint/TPP_DataAsset.TPP_DataAsset'"));
}
