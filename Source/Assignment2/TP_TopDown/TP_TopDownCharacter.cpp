...
ATP_TopDownCharacter::ATP_TopDownCharacter()
{
	...
	PawnAttributeAsset = LoadObject<UMyPawnAttributesDataAsset>(nullptr, TEXT("/Script/Assignment2.MyPawnAttributesDataAsset'/Game/Blueprint/TopDown_DataAsset.TopDown_DataAsset'"));
}
